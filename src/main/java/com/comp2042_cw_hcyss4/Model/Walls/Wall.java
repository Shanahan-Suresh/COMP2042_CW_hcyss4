...
import com.comp2042_cw_hcyss4.Model.Balls.*;
import com.comp2042_cw_hcyss4.Model.Bricks.*;
import com.comp2042_cw_hcyss4.Model.Player;


import static com.comp2042_cw_hcyss4.Model.Walls.LevelCreate.*;
...
public class Wall {
    ...
    private Brick[][] makeLevels(Rectangle drawArea, int brickCount, int lineCount, double brickDimensionRatio){
        ...
        temp[0] = makeSingleTypeLevel(drawArea, brickCount, lineCount, brickDimensionRatio, WallType.CLAY);
        temp[1] = makeChessboardLevel(drawArea, brickCount, lineCount, brickDimensionRatio, WallType.CLAY, WallType.CEMENT);
        temp[2] = makeChessboardLevel(drawArea, brickCount, lineCount, brickDimensionRatio, WallType.CLAY, WallType.STEEL);
        temp[3] = makeChessboardLevel(drawArea, brickCount, lineCount, brickDimensionRatio, WallType.STEEL, WallType.CEMENT);
        temp[4] = makeChessboardLevel(drawArea, brickCount, lineCount, brickDimensionRatio, WallType.STEEL, WallType.DIAMOND);
